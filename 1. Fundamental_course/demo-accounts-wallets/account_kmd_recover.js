...
(async () => {
    ...
    const walletMnemonic = "menu eagle scene royal improve neither ten transfer raise exotic smoke chapter place media song green brave true phrase enemy spoon romance blood abstract antenna";
